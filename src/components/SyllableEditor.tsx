...
export function SyllableEditor({ initialGroups, onBack, onSubmit }: Props) {
  ...
  return (
    <div className="panel">
      ...
      <p className="hint">
        ...
        add or remove &middot; marks to change where it breaks.
      </p>
      <div className="syllable-editor">
        {lineIndexes.map((lineIndex) => (
          <div className="syllable-line" key={lineIndex}>
            {groups
